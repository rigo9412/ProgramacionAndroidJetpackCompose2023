...
import com.otop.CURPGenerator.form.domains.estados
import com.otop.CURPGenerator.form.domains.generos
...
class FormViewModel(): ViewModel() {
    ...
    fun generateCURP() {
        ...
        try{
            _uiState.value = FormUiState.Loading("ajaja que significa CURP?")
            var curp = ""
            ...
            _uiState.value = FormUiState.Error("EY NO MANCHES CARNAL QUE HICISTE???")
