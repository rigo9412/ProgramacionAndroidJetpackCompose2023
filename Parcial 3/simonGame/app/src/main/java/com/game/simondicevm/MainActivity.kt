...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            //este es mi viewmodel de mi simondice
            val viewModel: SimonViewModel by viewModels()

            //este es el viewmodel del Top, osea el del profe
            ...
            SimonDiceVMTheme {
                ...
                Surface(
                    ...
                    //pantalla principal de mi simondice
                    //GameScreen(viewModel = viewModel, viewModel2 = viewModel2)

                    //con este se hace el post, poner los parametros que quieran, correr una vez y lo vuelven a comentar
                    //viewModel2.postTopFake(Player(null,"test",5,1))

                    //pantalla que muestra la informacion del get
