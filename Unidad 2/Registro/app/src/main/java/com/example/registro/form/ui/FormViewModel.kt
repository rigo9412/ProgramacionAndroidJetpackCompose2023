...
import com.example.registro.form.ui.DatePickerBirthDate
import RadioButtonGroupSex
...
import com.example.registro.components.EmptyView
import com.example.registro.components.ErrorView
import com.example.registro.components.LoadingView
    ...
    Scaffold(
        ...
        content = {
            Column(
                ...
                CustomInput(
                    label = stringResource(com.example.registro.R.string.app_name),
                    value = data.name,
