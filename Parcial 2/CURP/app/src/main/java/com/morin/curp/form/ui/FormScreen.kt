...
import com.morin.curp.form.ui.components.CustomInput
import com.morin.curp.form.ui.components.DatePicker
import com.morin.curp.form.ui.components.DropdownStates
import com.morin.curp.form.ui.components.RadioButtonGroupSex
import com.morin.curp.views.EmptyView
import com.morin.curp.views.ErrorView
import com.morin.curp.views.LoadingView
...
fun Form(viewModel: FormViewModel) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text("APP DE CREACION DE CURP", color = Color.White) },
            )
        },
