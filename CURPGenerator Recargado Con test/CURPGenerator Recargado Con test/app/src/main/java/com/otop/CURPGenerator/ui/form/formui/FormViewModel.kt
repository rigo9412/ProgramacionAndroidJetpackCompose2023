...
import com.otop.CURPGenerator.ui.AddCases.*
import com.otop.CURPGenerator.ui.form.domains.estados
...
class FormViewModel(
    private val addNameUseCase: AddName = AddName(),
    private val addBirthUseCase: AddBirth = AddBirth(),
    private val addGenderCase: AddGender = AddGender(),
    private val addStateUseCase: AddState = AddState(),
    private val getCurpUseCase: AddCurp = AddCurp()
