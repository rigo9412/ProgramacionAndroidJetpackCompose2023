//Elaborar una función que reciba un texto y cuente cuantas veces aparece una letra en el texto.
...
fun main() {
    ...
    println(contar(texto).toSortedMap())
}