...
import com.game.simondicevm.domain.models.getresponse.GetResponseTop
import com.game.simondicevm.domain.models.postrequest.PostRequest
import com.game.simondicevm.domain.models.getresponse.TopResponse
...
interface IApiService {
    ...
    @Headers("Authorization: Bearer $ACCESS_TOKEN")
    @POST("api/tops")
    suspend fun postTop(@Body requestTop: PostRequest): GetResponseTop
}